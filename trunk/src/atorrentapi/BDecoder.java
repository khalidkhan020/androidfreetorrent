...
public class BDecoder 
{
    ...
    //DW 10-13-10 - This is a minor bottleneck in the process. Can I make it faster, or at least return some status info?
            ...
            throws IOException 
    {
        ...
        default: 
        {
            ...
            throw (new IOException("BDecoder: unknown command '" + tempByte + ", remainder = "
            		+ new String(rem_data)));
        	}
        }
    }
