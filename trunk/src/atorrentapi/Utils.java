...
public class Utils 
{
    ...
    {
    	//DW 10-25-10 - THIS is where a whole lot of RAM is being eaten.
        byte[] b3 = new byte[b1.length + b2.length];
        System.arraycopy(b1, 0, b3, 0, b1.length);
        System.arraycopy(b2, 0, b3, b1.length, b2.length);
        //DW 10-25-10 - Trying to make this less terrible on RAM, pretty sure this wont help
        b1 = null;
        b2 = null;
        return b3;
    }
    ...
    public static byte[] concat(byte[] b1, byte b2) 
    {
        ...
        //Again, trying to ease up on RAM in vain.
        b1 = null;
        return b3;
    }
    ...
    {
    	//DW 10-25-10 - Is this function necessary?
    	//I'm going to try to replace it with System.Arraycopy
    	//In Message_PP, where it eats a lot of memory
    	//in each MessageReceiver thread (16kb per)
    	//If not, I can make this cleaner
    	
        byte[] sub = new byte[length];
        
        //DW 10-25-10 - New code
