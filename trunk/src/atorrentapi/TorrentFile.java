...
public class TorrentFile {
    ...
    //DW 10-20-10 - Probably don't need to store all 3 of these at once.
    public ArrayList piece_hash_values_as_binary; //11 references
    public ArrayList piece_hash_values_as_hex; //3 references
    public ArrayList piece_hash_values_as_url; //3 references
